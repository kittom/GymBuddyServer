    ...
    def normalise(self):
        ...
        if self.model == "apple":
            ...
            for row in range(0, len(self.dataframe)):
                ...
                hips = [(self.dataframe._get_value(row, "LeftHipX") + self.dataframe._get_value(row, "RightHipX")) / 2,
                                (self.dataframe._get_value(row, "LeftHipY") + self.dataframe._get_value(row, "RightHipY")) / 2]
                nose = [self.dataframe._get_value(row, "NeckX"), self.dataframe._get_value(row, "NeckY")]
