...
from .serializers import AccountSerializer, ExerciseSerializer, ExerciseQualityUpdateSerializer, WorkoutSerializer, FriendSerializer, PostSerializer, LikeSerializer, FriendGetSerializer
...
from ml_analysis.trainingdataloader import training_data
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if prediction[0] == 1:
                ...
                prediction = "bad"
            updated_data = {
                'quality': prediction  # Assuming prediction is one of 'unchecked', 'good', or 'bad'
            }
