...
class AccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Account
        fields = ['id','first_name', 'last_name', 'username', 'password', 'email', "xp"]
...
class AccountXpUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Account
        fields = ['xp']
...
class WorkoutSerializer(serializers.ModelSerializer):
    class Meta:
        model = Workout
        fields = ['id', 'account', 'startTime', 'endTime', 'title', 'description', 'xp']
...
class StreakGetSerializer(serializers.ModelSerializer):
